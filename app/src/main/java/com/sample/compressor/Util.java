...
public class Util {
    ...
    public static String getFilePath(Context context, Uri uri) throws URISyntaxException {
        ...
        if (Build.VERSION.SDK_INT >= 19 && DocumentsContract.isDocumentUri(context.getApplicationContext(), uri)) {
            if (isExternalStorageDocument(uri)) {
                ...
                return context.getExternalFilesDir("video-compresser")+ "/" + split[1];
    ...
    public static  OutputStream getLogStream(Context context) throws IOException {
        ...
        File file  = new File(context.getExternalFilesDir("video-compresser"), fileName);
    ...
    public static boolean hasStoragePermission(int requestCode, Context context) {
